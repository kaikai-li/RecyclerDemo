...
import com.example.recyclerdemo.snaphelper.custom.EdgeSnapHelper

/**
 * @author 李开开 <a href="likaikai5566@126.com">Email</a>
 * @date 2023/07/11 10:58 PM
 */
class EdgeSnapHelperActivity: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        EdgeSnapHelper().attachToRecyclerView(recyclerView)
    }
